...
const CATS = [
  { id:'all',   name:'All Ads',             emoji:'🛍️', color:'#E8F5E9' },
  { id:'cars',  name:'Cars & Bakkies',      emoji:'🚗', color:'#E3F2FD' },
  { id:'prop',  name:'Property',            emoji:'🏠', color:'#FFF8E1' },
  { id:'elec',  name:'Electronics',         emoji:'📱', color:'#EDE7F6' },
  { id:'home',  name:'Home & Garden',       emoji:'🌿', color:'#F1F8E9' },
  { id:'fash',  name:'Fashion',             emoji:'👗', color:'#FCE4EC' },
  { id:'jobs',  name:'Jobs',                emoji:'💼', color:'#E8EAF6' },
  { id:'baby',  name:'Baby & Kids',         emoji:'🍼', color:'#FFF3E0' },
  { id:'pets',  name:'Pets',                emoji:'🐾', color:'#F3E5F5' },
  { id:'moto',  name:'Motorcycles',         emoji:'🏍️', color:'#FFEBEE' },
  { id:'sport', name:'Sport & Leisure',     emoji:'⚽', color:'#E0F7FA' },
  { id:'tools', name:'Tools & DIY',         emoji:'🔧', color:'#ECEFF1' },
  { id:'furn',  name:'Furniture',           emoji:'🪑', color:'#FBE9E7' },
  { id:'music', name:'Musical Instruments', emoji:'🎸', color:'#F9FBE7' },
  { id:'game',  name:'Gaming',              emoji:'🎮', color:'#EDE7F6' },
  { id:'beauty',name:'Health & Beauty',     emoji:'💄', color:'#FCE4EC' },
  { id:'serv',  name:'Services',            emoji:'🛠️', color:'#E8F5E9' },
  { id:'agri',  name:'Agriculture',         emoji:'🌾', color:'#F9FBE7' },
  { id:'camp',  name:'Caravans & Camping',  emoji:'🏕️', color:'#E0F2F1' },
  { id:'books', name:'Books & Stationery',  emoji:'📚', color:'#FFF8E1' },
];
...
const LISTINGS = [
  { id:1001, title:'iPhone 15 Pro 256GB – Space Black',       cat:'elec', price:17999,  loc:'Sandton, Gauteng',           cond:'Used – Like New', seller:'Thabo M',    sellerType:'private', verified:true,  desc:'Purchased 4 months ago. Excellent condition. Original box, charger and case included. No scratches.',           postedAt:Date.now()-3600000*2,   art:'phone',    badge:'featured', neg:false },
  { id:1002, title:'2019 Toyota Hilux 2.8 GD-6 Double Cab',   cat:'cars', price:429900, loc:'Pretoria, Gauteng',          cond:'Pre-owned',       seller:'AutoHouse',  sellerType:'dealer',  verified:true,  desc:'92 000km. Full Toyota service history. Canopy, tow bar, bull bar. No accidents. One owner.',                   postedAt:Date.now()-3600000*6,   art:'truck',    badge:'featured', neg:true  },
  { id:1003, title:'3 Bedroom House – Claremont',              cat:'prop', price:3250000,loc:'Claremont, Western Cape',   cond:'N/A',             seller:'Cape Homes', sellerType:'dealer',  verified:true,  desc:'Spacious family home, 2 bathrooms, double garage, solar geyser. Walking distance to schools.',                 postedAt:Date.now()-86400000*1,  art:'house',    badge:'featured', neg:true  },
  { id:1004, title:'Samsung 65" QLED 4K Smart TV',             cat:'elec', price:8500,   loc:'Durban, KwaZulu-Natal',     cond:'Used – Good',     seller:'Sipho N',    sellerType:'private', verified:false, desc:'2 years old, works perfectly. Selling due to upgrade. Remote and stand included.',                              postedAt:Date.now()-86400000*2,  art:'tv',       badge:null,       neg:false },
  { id:1005, title:'Golden Retriever Puppies – Ready Now',     cat:'pets', price:3500,   loc:'Centurion, Gauteng',        cond:'N/A',             seller:'Lisa van W', sellerType:'private', verified:false, desc:'8 weeks old. Vaccinated and dewormed. Parents on site. Loving family home.',                                  postedAt:Date.now()-3600000*12,  art:'dog',      badge:null,       neg:false },
  { id:1006, title:'Electrician – Residential & Commercial',   cat:'jobs', price:0,      loc:'Cape Town, Western Cape',   cond:'N/A',             seller:'JB Electric', sellerType:'dealer', verified:true,  desc:'Qualified electrician. Fault finding, DB board upgrades, solar installations. Call for a free quote.',         postedAt:Date.now()-86400000*3,  art:'tools',    badge:null,       neg:false },
  { id:1007, title:'2021 Honda CB500F Motorcycle',             cat:'cars', price:74900,  loc:'Port Elizabeth, Eastern Cape',cond:'Pre-owned',      seller:'Riaan P',    sellerType:'private', verified:false, desc:'18 000km. Pristine condition. Serviced, new tyres. Comes with helmet and jacket.',                              postedAt:Date.now()-86400000*1,  art:'moto',     badge:null,       neg:true  },
  { id:1008, title:'Solid Wood Dining Table – 6 Seater',       cat:'home', price:4200,   loc:'Bloemfontein, Free State',  cond:'Used – Good',     seller:'Maria S',    sellerType:'private', verified:false, desc:'Solid yellowwood table with 6 matching chairs. Minor surface marks. Must collect.',                             postedAt:Date.now()-86400000*4,  art:'table',    badge:null,       neg:true  },
  { id:1009, title:'Nike Air Max 270 – Size 10 (New)',         cat:'fash', price:1850,   loc:'Johannesburg, Gauteng',     cond:'New with tags',   seller:'Zanele K',   sellerType:'private', verified:false, desc:'Bought wrong size. Never worn, original box and receipt. Black/White colourway.',                               postedAt:Date.now()-3600000*8,   art:'sneakers', badge:'new',      neg:false },
  { id:1010, title:'PlayStation 5 Console + 2 Controllers',   cat:'elec', price:9500,   loc:'Polokwane, Limpopo',        cond:'Used – Like New', seller:'Neo M',      sellerType:'private', verified:false, desc:'Bought 8 months ago. Comes with 3 games. Original packaging. No issues whatsoever.',                           postedAt:Date.now()-86400000*2,  art:'ps5',      badge:null,       neg:true  },
  { id:1011, title:'2 Bedroom Apartment To Let – Sea Point',  cat:'prop', price:14500,  loc:'Sea Point, Western Cape',   cond:'N/A',             seller:'Atlantic PM',sellerType:'dealer',  verified:true,  desc:'Modern apartment, fully furnished, sea views. Fibre internet, parking, pool. Available 1st.',                   postedAt:Date.now()-3600000*10,  art:'apt',      badge:'featured', neg:false },
  { id:1012, title:'Graphic Designer – Freelance',             cat:'jobs', price:0,      loc:'Durban, KwaZulu-Natal',     cond:'N/A',             seller:'Priya R',    sellerType:'private', verified:true,  desc:'Logos, branding, social media, print. 5 years experience. Portfolio available on request.',                    postedAt:Date.now()-86400000*5,  art:'design',   badge:null,       neg:false },
];
