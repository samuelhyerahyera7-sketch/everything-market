/* GET /api/admin-verification-file?path=...
   Admin-only private storage viewer for manual identity review photos.
*/
'use strict';
...
module.exports = async function handler(req, res) {
  ...
  storageReq.on('error', () => res.status(502).json({ error: 'Could not fetch verification file' }));
  storageReq.end();
};
